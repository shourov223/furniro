...
const ProductCard = ({
	...
	return (
		<div className="relative group">
			<div className="absolute z-50 top-0 left-0 min-w-0 h-full bg-black opacity-0 group-hover:opacity-50 group-hover:min-w-full transition-all duration-300"></div>
			...
			<div className="w-full h-[301px] relative group-hover:blur-[1px]">
				<div
					className={`size-[48px] rounded-full absolute top-6 right-6 ${availabilityStatus === "In Stock" ? "bg-[#2EC1AC]" : "bg-[#E97171]"} flex items-center justify-center`}
				>
			...
			<div className="bg-[#F4F5F7] px-4 pt-4 pb-[30px] group-hover:blur-[1px]">
				<h3 className="text-[#3A3A3A] text-[20px] font-semibold">
					{productName}
				</h3>
